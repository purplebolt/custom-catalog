...
namespace Youssuph\CustomCatalog\Model\ResourceModel\Eav;
...
class Attribute extends EavAttribute implements ScopedAttributeInterface
{
     ...
     * Constants
     */
    const MODULE_NAME = 'Youssuph_Customcat';
     ...
     * @var string
     */
    protected $_eventPrefix = CustomcatSetup::ENTITY_TYPE_CODE . '_entity_attribute';
    ...
    {
        $this->_init('Youssuph\CustomCatalog\Model\ResourceModel\Attribute');
    }
